...
@section('title', 'Flavora - Resep Berdasarkan Kategori') 
@section('content') 
<div class="container">
    <div class="heading_container heading_center mb-5">
        <h2 style="font-size: 50px; font-weight: normal; letter-spacing: 1px; color: #333; margin-top: 20px;">
            Resep - {{ $categorie->nama }}
        </h2>
